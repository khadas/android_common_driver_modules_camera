...
#define ADAP_TOP_TO_BASE_OFFSET  0x3000
#define ADAP_FE2_TO_BASE_OFFSET  0x800
...
#define MIPI_TOP_ADAPT_DE_CTRL0              (0xc1 << 2) // 0x304

// 32*3 = 96 bits.
// irq mask bits. set 1 to enable irq. set 0 to disable irq.
// 6 fe irqs: ddr mode frame start & end; direct mode ddr start & end
//     frame isp data have been write to ddr; frame ddr data have been write to ddr
#define MIPI_TOP_ISP_PENDING_MASK0           (0xf0 << 2) // 0x3c0
#define MIPI_TOP_ISP_PENDING_MASK1           (0xf1 << 2)
#define MIPI_TOP_ISP_PENDING_MASK2           (0xf2 << 2)

// 32*3 = 96 bits.
// irq status. read to check if irq has occurred. set 1 to clear irq.
#define MIPI_TOP_ISP_PENDING0                (0xf3 << 2)
#define MIPI_TOP_ISP_PENDING1                (0xf4 << 2)
#define MIPI_TOP_ISP_PENDING2                (0xf5 << 2)
