...
extern int ov5640_init(struct i2c_client *client, void *sdrv);
extern int ov5640_deinit(struct i2c_client *client);
extern int ov5640_sensor_id(struct i2c_client *client);
extern int ov5640_power_on(struct device *dev, struct sensor_gpio *gpio);
extern int ov5640_power_off(struct device *dev, struct sensor_gpio *gpio);
extern int ov5640_power_suspend(struct device *dev);
extern int ov5640_power_resume(struct device *dev);
